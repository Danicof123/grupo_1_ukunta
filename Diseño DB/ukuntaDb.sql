...
--
-- Host: 127.0.0.1    Database: ukuntadb
-- ------------------------------------------------------
...
CREATE TABLE `cartproduct` (
  ...
  CONSTRAINT `FK_79be3f3c-4cd8-46bb-ab21-ec6c26f86d1e` FOREIGN KEY (`productId`) REFERENCES `product` (`id`),
...
CREATE TABLE `images` (
  ...
  CONSTRAINT `FK_003eafc3-efcd-4ba8-a3e2-1b7552dd5e3d` FOREIGN KEY (`productId`) REFERENCES `product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-15 23:41:51
